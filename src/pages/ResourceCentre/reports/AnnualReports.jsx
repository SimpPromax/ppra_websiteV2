// src/pages/ResourceCentre/AnnualReports.jsx
...
const AnnualReports = () => {
  ...
  // Service state
  const [state, setState] = useState(() => annualReportsService.getState());
  ...
  useEffect(() => {
    const unsubscribe = annualReportsService.subscribe((newState) => {
      setState(newState);
    });
    annualReportsService.fetchReports();
    return unsubscribe;
  }, []);
  ...
  useEffect(() => {
    ...
    if (heroRef.current) {
      gsap.fromTo(heroRef.current.querySelector('.annual-hero_heading'),
        { y: 50, opacity: 0 },
        {
          y: 0,
          opacity: 1,
    ...
    return (
      <div className="page-wrapper bg-white min-h-screen flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <button
            onClick={() => annualReportsService.fetchReports({ forceRefresh: true })}
  ...
  return (
    <div className="page-wrapper bg-white">
      <Helmet>
        <title>Annual Reports | PPRA Kenya</title>
        <meta name="description" content="Access PPRA Annual Reports - comprehensive reports on public procurement activities in Kenya." />
        <meta name="keywords" content="annual reports, PPRA, procurement, Kenya, public procurement, regulatory reports" />
        <meta property="og:title" content="Annual Reports - PPRA Kenya" />
        <meta property="og:description" content="Comprehensive annual reports on public procurement activities in Kenya." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content={logoImage} />
        <link rel="canonical" href="https://ppra.go.ke/annual-reports" />
      </Helmet>
      ...
      <main className="main-wrapper">
        ...
        {/* ===== HERO SECTION ===== */}
        <section className="section-annual-hero relative pt-8">
          ...
          <div className="padding-global z-index-1 relative px-4 md:px-6 lg:px-12">
            <div className="container-large max-w-7xl mx-auto">
              <div ref={heroRef} className="annual-hero_component relative h-[45vh] md:h-[50vh] lg:h-[55vh] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 w-full h-full">
                  <img src={corporateSky} alt="PPRA Annual Reports" className="w-full h-full object-cover" loading="eager" />
                </div>
                ...
                <div className="annual-hero_heading max-w-4xl mx-auto text-center z-10 px-4">
                  ...
                  <p className="text-white text-sm md:text-xl mt-2 md:mt-4 opacity-90 max-w-2xl mx-auto animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
                    Comprehensive reports on public procurement activities
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* ===== CONTENT SECTION ===== */}
        <section className="section-annual-content relative bg-white">
          <div className="line-wrapper is-invert absolute inset-0 pointer-events-none flex">
            <div className="vertical-line w-1/5 border-r border-gray-200"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            <div className="vertical-line w-1/5 border-none"></div>
          ...
          <div className="z-index-1 relative">
            <div className="padding-global padding-section-large px-4 md:px-6 lg:px-12 py-10 md:py-24">
              <div className="container-large max-w-4xl mx-auto">
                <div ref={containerRef} className="annual-component">
