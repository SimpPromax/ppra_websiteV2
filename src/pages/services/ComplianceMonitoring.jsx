// src/pages/ComplianceMonitoring.jsx
...
const services = [
  {
    id: 1,
    title: 'Pre-Bid Compliance Monitoring',
    icon: faEye,
    description: 'PPRA reviews procurement activities before tender closing to identify and address potential non-compliance at an early stage.',
    detailHeader: 'Reviews may cover:',
    details: [
      'Annual Procurement Plans',
      'Tender notices and tender documents',
      'Procurement methods',
      'Qualification and evaluation criteria',
      'Technical specifications and Bills of Quantities',
      'Tender securities and submission requirements',
      'Standard Tender Documents and Conditions of Contract',
      'Preference and reservation requirements'
    ],
    note: 'Where non-compliance is identified, PPRA may require the Procuring Entity to undertake corrective action before the procurement proceeds.'
  },
  {
    id: 2,
    title: 'Procurement and Asset Disposal Assessments and Reviews',
    icon: faSearch,
    description: 'PPRA conducts assessments and reviews to determine whether the procurement and asset disposal systems, processes and transactions of Procuring Entities comply with the applicable legal and regulatory framework.',
    detailHeader: 'Areas reviewed may include:',
    details: [
      'Procurement planning',
      'Tender preparation, opening and evaluation',
      'Procurement methods and award decisions',
      'Institutional procurement arrangements',
      'Procurement and disposal records',
      'Preference and reservation schemes',
      'Beneficial ownership disclosures',
      'Mandatory procurement reporting'
    ],
    note: 'The findings are used to identify weaknesses, recommend improvements and strengthen compliance within Procuring Entities.'
  },
  {
    id: 3,
    title: 'Contract Performance and Site Verification Audits',
    icon: faFileContract,
    description: 'PPRA conducts contract performance and site verification audits to establish whether contracts are implemented in accordance with the law and their agreed terms and conditions.',
    detailHeader: 'The audits assess, among other matters:',
    details: [
      ...
      'Inspection, acceptance and payment processes',
      'Project completion and operational status',
      'Achievement of value for money'
    ],
    note: 'These audits help identify delays, stalled projects, poor contract management practices and other risks that may affect service delivery and the prudent use of public resources.'
  },
  {
    id: 4,
    title: 'Specialized Audits and Inspections',
    icon: faPenFancy,
    description: 'PPRA undertakes specialized audits and inspections where enhanced regulatory scrutiny is required.',
    detailHeader: 'These may cover:',
    details: [
      'Selected procurement proceedings',
      'Specific contracts',
      'Classified procurement',
      'Specially permitted procurement',
      'Complex procurement',
      'Other areas requiring targeted regulatory examination'
    ],
    note: 'Specialized audits may examine procurement planning, tendering, evaluation, contract award, governance arrangements, statutory reporting, documentation and contract management.'
  },
  {
    id: 5,
    title: 'Monitoring of Statutory Reports and Disclosures',
    icon: faClipboardList,
    description: 'PPRA monitors compliance with statutory procurement and asset disposal reporting requirements, including information relating to:',
    detailHeader: 'including information relating to:',
    details: [
      'Procurement plans',
      ...
      'Contract terminations and variations',
      'Direct procurement',
      'Other mandatory procurement reports'
    ],
    note: 'This supports transparency, accountability and effective regulatory oversight of the public procurement system.'
  },
  {
    id: 6,
    title: 'Compliance Reporting, Directives and Follow-Up',
    icon: faFileAlt,
    description: 'Following compliance reviews, assessments, inspections and audits, PPRA prepares reports outlining findings, areas of non-compliance, recommendations and required corrective actions.',
    detailHeader: 'PPRA\'s compliance monitoring services seek to:',
    details: [
      'Promote compliance with public procurement and asset disposal laws and regulations',
      'Safeguard constitutional principles governing public procurement',
      'Strengthen transparency, accountability, fairness and competition',
      'Promote implementation of preference and reservation schemes',
      'Improve procurement planning and contract management',
      'Identify and address procurement risks and systemic weaknesses',
      'Strengthen statutory procurement reporting',
      'Promote value for money and quality public service delivery'
    ],
    note: 'The Authority also follows up on implementation of recommendations and directives to ensure that identified weaknesses are addressed and procurement practices continuously improve.'
  }
];
...
const whoWeServe = [
  {
    icon: faBuilding,
    title: 'National Government Entities',
    description: 'Ministries, departments and agencies at the national level'
  },
  {
    icon: faBuilding,
    title: 'County Governments',
    description: 'County governments and their entities'
  },
  {
    icon: faBuilding,
    title: 'State Corporations and Agencies',
    description: 'Parastatals and state-owned enterprises'
  },
  {
    icon: faBuilding,
    title: 'Constitutional Commissions',
    description: 'Independent constitutional commissions'
  },
  {
    icon: faBuilding,
    title: 'County Assemblies',
    description: 'Legislative bodies at the county level'
  },
  {
    icon: faBuilding,
    title: 'Public Institutions',
    description: 'Public universities, colleges, schools, hospitals and public funds'
  }
];

// Key Outputs Data
const keyOutputs = [
  'Compliance assessment and review reports',
  'Pre-bid monitoring reports',
  'Contract performance and site verification audit reports',
  'Specialized audit and inspection reports',
  'Compliance directives',
  'Recommendations and corrective actions',
  'Follow-up reports on implementation of recommendations'
];
...
const ComplianceMonitoring = () => {
  ...
  useEffect(() => {
    // Hero animation
    if (heroRef.current) {
      gsap.fromTo(heroRef.current.querySelector('.compliance-hero_heading'),
        { y: 50, opacity: 0 },
        {
          y: 0,
          opacity: 1,
  ...
  return (
    <div className="page-wrapper bg-white">
      <Helmet>
        <title>Compliance Monitoring, Assessments, Reviews & Auditing | PPRA Kenya</title>
        <meta name="description" content="PPRA monitors, assesses and reviews public procurement and asset disposal to ensure compliance with national values and constitutional principles." />
        <meta name="keywords" content="PPRA, compliance monitoring, procurement audits, procurement reviews, compliance assessment, Kenya" />
        <meta property="og:title" content="Compliance Monitoring, Assessments, Reviews & Auditing - PPRA Kenya" />
        <meta property="og:description" content="Ensuring fairness, equity, transparency, competitiveness and accountability in public procurement." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content={logoImage} />
        <link rel="canonical" href="https://ppra.go.ke/compliance-monitoring" />
      </Helmet>
      ...
      <main className="main-wrapper">
        ...
        <section className="section-compliance-hero relative pt-8">
          ...
          <div className="padding-global z-index-1 relative px-4 md:px-6 lg:px-12">
            <div className="container-large max-w-7xl mx-auto">
              <div ref={heroRef} className="compliance-hero_component relative h-[45vh] md:h-[50vh] lg:h-[55vh] flex items-center justify-center">
                <div className="absolute inset-0 parallax w-full h-full">
                  <img 
                    src={corporateSky} 
                    alt="Compliance Monitoring - PPRA Kenya" 
                    className="w-full h-full object-cover"
                    loading="eager"
                  />
                </div>
                <div className="compliance-hero_gradient absolute inset-0 bg-primary-purple-dark/60"></div>
                ...
                <div className="compliance-hero_heading max-w-4xl mx-auto text-center z-10 px-4">
                  ...
                  <h1 className="heading-style-h1 text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold animate-fadeInUp leading-tight">
                    Compliance Monitoring, Assessments, Reviews & Auditing
                  </h1>
                  <p className="text-white text-base sm:text-lg md:text-xl lg:text-2xl mt-3 md:mt-4 opacity-90 animate-fadeInUp leading-relaxed" style={{ animationDelay: '0.2s' }}>
                    Ensuring fairness, equity, transparency, competitiveness and accountability in public procurement
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="overview_component">
                  <div className="overview_header text-center mb-10 md:mb-16">
                    ...
                    <h2 className="heading-style-h2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-purple leading-tight">
                      Ensuring Compliance Across the Procurement Lifecycle
                    </h2>
                  </div>
                    ...
                    <div className="text-color-black-light">
                      <div className="text-size-medium text-gray-700 space-y-4 md:space-y-5">
                        <p className="description-para text-base md:text-lg leading-relaxed">
                          The Public Procurement Regulatory Authority (PPRA) is mandated under Section 9(1)(a) and (b) of the Public Procurement and Asset Disposal Act, 2015 to monitor, assess and review the public procurement and asset disposal system, ensure compliance with national values and constitutional principles, including Article 227 of the Constitution, and make recommendations for improvement.
                        </p>
                        
                        <p className="description-para text-base md:text-lg leading-relaxed">
                          PPRA undertakes compliance monitoring across the procurement and asset disposal lifecycle — from procurement planning and tendering to contract award, implementation and completion. The objective is to promote fairness, equity, transparency, competitiveness, accountability, cost-effectiveness and value for money in public procurement.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="services_component">
                  <div className="services_header text-center mb-10 md:mb-14">
                    ...
                    <p className="text-gray-600 text-base md:text-lg mt-4 max-w-3xl mx-auto leading-relaxed">
                      Comprehensive monitoring across the procurement and asset disposal lifecycle
                    </p>
                  </div>
        ...
        {/* KEY OUTPUTS SECTION */}
        {/* ============================================================ */}
        <section className="section-outputs relative bg-white">
          <div className="line-wrapper is-invert absolute inset-0 pointer-events-none flex">
            <div className="vertical-line w-1/5 border-r border-gray-200"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            <div className="vertical-line w-1/5 border-none"></div>
          ...
          <div className="z-index-1 relative">
            <div className="padding-global padding-section-large px-4 md:px-6 lg:px-12 py-12 md:py-20">
              <div className="container-large max-w-7xl mx-auto">
                <div className="outputs_component">
                  <div className="outputs_header text-center mb-10 md:mb-14">
                    <div className="pill-wrapper flex justify-center mb-4">
                      <div className="pill is-black inline-block bg-primary-purple text-white text-sm px-4 py-1.5">KEY OUTPUTS</div>
                    </div>
                    <div className="heading-animate">
                      <h2 className="heading-style-h2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-purple leading-tight">
                        What We Deliver
                    ...
                    <p className="text-gray-600 text-base md:text-lg mt-4 max-w-3xl mx-auto leading-relaxed">
                      The service produces a comprehensive range of reports and directives
                    </p>
                  </div>
                  ...
                  <div className="max-w-4xl mx-auto">
                    <div className="space-y-3 md:space-y-4">
                      {keyOutputs.map((output, index) => (
                        <div key={index} className="flex items-start gap-3 p-3 md:p-4 bg-gray-50 border border-gray-200 hover:border-primary-purple/30 hover:shadow-md transition-all duration-300">
                          <div className="w-8 h-8 bg-primary-purple/10 rounded-lg flex items-center justify-center shrink-0 mt-0.5">
                            <FontAwesomeIcon icon={faFileAlt} className="text-primary-purple text-sm" />
                          </div>
                          <p className="text-gray-700 text-sm md:text-base leading-relaxed">{output}</p>
                        </div>
                      ))}
                    </div>
                  </div>
        ...
        {/* ============================================================ */}
        <section className="section-serve relative bg-gray-50">
          <div className="line-wrapper is-invert absolute inset-0 pointer-events-none flex">
            <div className="vertical-line w-1/5 border-r border-gray-200"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            <div className="vertical-line w-1/5 border-none"></div>
              ...
              <div className="container-large max-w-7xl mx-auto">
                <div className="serve_component">
                  <div className="serve_header text-center mb-10 md:mb-14">
                    ...
                    <p className="text-gray-600 text-base md:text-lg mt-4 max-w-3xl mx-auto leading-relaxed">
                      Compliance monitoring covers Procuring Entities across the National and County Governments
                    </p>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto">
                    {whoWeServe.map((item, index) => (
                      <div key={index} className="bg-white p-5 md:p-6 border border-gray-200 hover:border-primary-purple/30 hover:shadow-md transition-all duration-300 text-center">
                  ...
                  <div className="mt-10 md:mt-14 max-w-4xl mx-auto">
                    <div className="bg-primary-purple/5 border-l-4 border-primary-purple p-4 md:p-6">
                      <p className="text-base md:text-lg leading-relaxed text-gray-700 mb-0">
                        <FontAwesomeIcon icon={faUsers} className="text-primary-purple mr-2" />
                        The service also benefits suppliers, contractors, consultants and members of the public by promoting a transparent, fair and accountable public procurement system.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {/* ============================================================ */}
        {/* WHY COMPLIANCE MONITORING MATTERS SECTION */}
        {/* ============================================================ */}
              ...
              <div className="container-large max-w-7xl mx-auto">
                <div className="importance_component">
                  <div className="importance_header text-center mb-10 md:mb-14">
                    <div className="pill-wrapper flex justify-center mb-4">
                      <div className="pill is-black inline-block bg-primary-purple text-white text-sm px-4 py-1.5">WHY COMPLIANCE MONITORING MATTERS</div>
                    </div>
                    <div className="heading-animate">
                      <h2 className="heading-style-h2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-purple leading-tight">
                  ...
                  <div className="max-w-4xl mx-auto">
                    <div className="space-y-4 md:space-y-5">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                              Effective compliance monitoring helps prevent and address procurement irregularities, strengthens procurement governance and promotes responsible use of public resources.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-50 p-5 md:p-6 border border-gray-200 hover:border-primary-purple/30 transition-all duration-300">
                        <div className="flex items-start gap-4">
                          <div className="w-12 h-12 bg-primary-purple/10 rounded-lg flex items-center justify-center shrink-0">
                            <FontAwesomeIcon icon={faHandshake} className="text-primary-purple text-xl" />
                          </div>
                          <div>
                            <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                              By intervening throughout the procurement lifecycle — from planning and tendering to contract implementation — PPRA helps ensure that public procurement remains fair, equitable, transparent, competitive, accountable and cost-effective, while supporting value for money and improved service delivery.
                            </p>
                          </div>
                        </div>
                      </div>
