// src/pages/services/TechnicalSupport.jsx
...
const TechnicalSupport = () => {
  ...
  // Who may request technical support
  const requesters = [
    'National and county government entities',
    'Constitutional commissions and independent offices',
    'State corporations, public universities and other procuring entities',
    'Accounting officers, governing bodies and procurement functions',
    'Suppliers, contractors and other procurement stakeholders',
    'Professional, oversight and public-sector institutions',
    'Development partners and organizations supporting public procurement reforms'
  ];

  // Areas of technical support
  const supportAreas = [
    'Interpretation and application of the Public Procurement and Asset Disposal Act and Regulations',
    'Use of standard tender and asset disposal documents',
    'Procurement and asset disposal planning',
    'Preference and reservation schemes',
    'Tender preparation and application of prescribed procedures',
    'Contract management and performance monitoring',
    'Procurement reporting and publication requirements',
    'Governance, accountability and internal-control arrangements',
    'Implementation of PPRA circulars, standards, guidelines and directives',
    'Use of PPRA regulatory systems and information resources',
    'Institutional process improvement',
    'Participation in approved technical forums, sensitisation sessions and consultative meetings'
  ];

  // What to include in request
  const requestContents = [
    'The name and contact details of the requesting institution or person',
    'A clear description of the issue requiring guidance',
    'Relevant background and material facts',
    'The procurement or asset disposal stage involved',
    'Specific questions requiring clarification',
    'Relevant sections of the Act, Regulations, tender documents or PPRA guidelines',
    'Supporting documents',
    'Any applicable deadline or urgency'
  ];

  return (
    <div className="page-wrapper bg-white">
      <Helmet>
        <title>Technical Support | PPRA Kenya</title>
        <meta name="description" content="Practical guidance on the application of Kenya's public procurement and asset disposal framework. PPRA provides technical support to public entities and stakeholders." />
        <meta name="keywords" content="PPRA, technical support, procurement guidance, public procurement, Kenya, procurement advice" />
        <meta property="og:title" content="Technical Support - PPRA Kenya" />
        <meta property="og:description" content="Practical guidance on public procurement and asset disposal framework." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content={logoImage} />
        <link rel="canonical" href="https://ppra.go.ke/services/technical-support" />
      </Helmet>
      ...
      <main className="main-wrapper">
            ...
            <div className="container-large max-w-7xl mx-auto">
              <div ref={heroRef} className="service-hero_component relative h-[45vh] md:h-[50vh] lg:h-[55vh] flex items-center justify-center">
                <div className="absolute inset-0 parallax w-full h-full">
                  <img src={corporateSky} alt="Technical Support" className="w-full h-full object-cover" loading="eager" />
                </div>
                ...
                <div className="service-hero_heading max-w-4xl mx-auto text-center z-10 px-4">
                  ...
                  <p className="text-white text-base sm:text-lg md:text-xl lg:text-2xl mt-3 md:mt-4 opacity-90 animate-fadeInUp leading-relaxed" style={{ animationDelay: '0.2s' }}>
                    Practical guidance on the application of Kenya's public procurement and asset disposal framework
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="introduction_component">
                  <div className="introduction_header text-center mb-10 md:mb-12">
                    ...
                    <div className="heading-animate">
                      <h2 className="heading-style-h2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-purple leading-tight">
                        Guiding Procurement Excellence
                      </h2>
                    </div>
                  </div>
                  ...
                  <div>
                    <p className="text-base md:text-lg leading-relaxed text-gray-700">
                      PPRA provides advice and technical support upon request to help public entities and other stakeholders understand and apply procurement and asset disposal requirements effectively.
                    </p>
                    <p className="text-base md:text-lg leading-relaxed text-gray-700 mt-4">
                      The service supports lawful, fair, transparent, competitive and cost-effective procurement while strengthening institutional capacity, consistency and value for money.
                    </p>
                  </div>

                  <div className="mt-6 p-4 md:p-6 bg-primary-purple/5 border-l-4 border-primary-purple">
                    <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                      <strong>Related service:</strong> Where a request is primarily for structured training or institutional capacity building, it may be handled under PPRA's separate Capacity Building service and the applicable policy.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* WHO MAY REQUEST - No animations on cards */}
        <section className="section-requesters relative bg-gray-50">
          <div className="line-wrapper is-invert absolute inset-0 pointer-events-none flex">
            <div className="vertical-line w-1/5 border-r border-gray-200"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            <div className="vertical-line w-1/5 border-none"></div>
          ...
          <div className="z-index-1 relative">
            <div className="padding-global padding-section-large px-4 md:px-6 lg:px-12 py-12 md:py-20">
              <div className="container-large max-w-4xl mx-auto">
                <div className="requesters_component">
                  <div className="requesters_header text-center mb-10 md:mb-14">
                    <div className="pill-wrapper flex justify-center mb-4">
                      <div className="pill is-black inline-block bg-primary-purple text-white text-sm px-4 py-1.5">WHO CAN REQUEST</div>
                    </div>
                    <div className="heading-animate">
                      <h2 className="heading-style-h2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-purple leading-tight">
                        Who May Request Technical Support?
        ...
        {/* AREAS OF SUPPORT - No animations on cards */}
        <section className="section-areas relative bg-white">
          <div className="line-wrapper is-invert absolute inset-0 pointer-events-none flex">
            <div className="vertical-line w-1/5 border-r border-gray-200"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            ...
            <div className="padding-global padding-section-large px-4 md:px-6 lg:px-12 py-12 md:py-20">
              <div className="container-large max-w-4xl mx-auto">
                <div className="areas_component">
                  <div className="areas_header text-center mb-10 md:mb-14">
                    <div className="pill-wrapper flex justify-center mb-4">
                      <div className="pill is-black inline-block bg-primary-purple text-white text-sm px-4 py-1.5">AREAS OF SUPPORT</div>
                    </div>
                    <div className="heading-animate">
                      <h2 className="heading-style-h2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-purple leading-tight">
                        Areas of Technical Support
                    ...
                    <p className="text-gray-600 text-base md:text-lg mt-4 max-w-3xl mx-auto leading-relaxed">
                      PPRA may provide guidance on the following areas
                    </p>
                  </div>
        ...
        {/* HOW TO REQUEST - No animations on cards */}
        <section className="section-how-to-request relative bg-gray-50">
          <div className="line-wrapper is-invert absolute inset-0 pointer-events-none flex">
            <div className="vertical-line w-1/5 border-r border-gray-200"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            <div className="vertical-line w-1/5 border-none"></div>
          ...
          <div className="z-index-1 relative">
            <div className="padding-global padding-section-large px-4 md:px-6 lg:px-12 py-12 md:py-20">
              <div className="container-large max-w-4xl mx-auto">
                <div className="how-to-request_component">
                  <div className="how-to-request_header text-center mb-10 md:mb-14">
                    <div className="pill-wrapper flex justify-center mb-4">
                      <div className="pill is-black inline-block bg-primary-purple text-white text-sm px-4 py-1.5">HOW TO REQUEST</div>
                    </div>
                    <div className="heading-animate">
                      <h2 className="heading-style-h2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-purple leading-tight">
                    ...
                    <p className="text-gray-600 text-base md:text-lg mt-4 max-w-3xl mx-auto leading-relaxed">
                      Submit a formal letter or email containing the following information
                    </p>
                  </div>

                  <div className="space-y-3 md:space-y-4">
                    {requestContents.map((item, index) => (
