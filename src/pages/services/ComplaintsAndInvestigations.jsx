// src/pages/services/ComplaintsAndInvestigations.jsx
...
const ComplaintsAndInvestigations = () => {
  ...
  const complainants = [
    'A member of the public or whistleblower',
    'A procuring entity',
    'A candidate, tenderer, supplier or contractor',
    'A public institution or oversight agency',
    'Any person with information about suspected procurement or asset disposal irregularities'
  ];

  // Reportable matters
  const reportableMatters = [
    'Suspected breaches of procurement or asset disposal laws',
    'Irregularities in procurement planning, tendering, evaluation, award or contract implementation',
    'Conflict of interest, collusion, fraud or unethical conduct',
    'Failure to apply preference and reservation requirements',
    'Improper disposal of public assets',
    'Non-compliance with PPRA standards, circulars or directives',
    'Withholding or misreporting procurement information',
    'Recurring or systemic weaknesses within a procuring entity'
  ];

  // What complaint should contain
  const complaintContents = [
    'The name of the procuring entity',
    'The tender, contract or disposal reference number, where available',
    'A clear description of the alleged act or omission',
    'Relevant dates and the procurement stage',
    'Supporting documents, correspondence, photographs or other evidence',
    'Details of any action already taken',
    'Your contact information, unless submitting anonymously'
  ];

  // How PPRA handles complaints
  const handlingSteps = [
    'Register and acknowledge the complaint',
    'Assess jurisdiction, urgency and whether the matter is subject to administrative review',
    'Classify and assign the complaint for action',
    'Request relevant records, information or responses',
    'Conduct an assessment or investigation where warranted',
    'Analyse the evidence and prepare findings and recommendations',
    'Issue appropriate directions, make referrals or take other lawful action',
    'Communicate the outcome, subject to confidentiality and legal limitations'
  ];

  return (
    <div className="page-wrapper bg-white">
      <Helmet>
        <title>Complaints and Investigations | PPRA Kenya</title>
        <meta name="description" content="Report suspected non-compliance in public procurement and asset disposal. PPRA handles complaints and conducts investigations to promote accountability." />
        <meta name="keywords" content="PPRA, complaints, investigations, procurement, non-compliance, Kenya" />
        <meta property="og:title" content="Complaints and Investigations - PPRA Kenya" />
        <meta property="og:description" content="Report suspected non-compliance in public procurement and asset disposal." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content={logoImage} />
        <link rel="canonical" href="https://ppra.go.ke/services/complaints-and-investigations" />
      </Helmet>
      ...
      <main className="main-wrapper">
            ...
            <div className="container-large max-w-7xl mx-auto">
              <div ref={heroRef} className="service-hero_component relative h-[45vh] md:h-[50vh] lg:h-[55vh] flex items-center justify-center">
                <div className="absolute inset-0 parallax w-full h-full">
                  <img src={corporateSky} alt="Complaints and Investigations" className="w-full h-full object-cover" loading="eager" />
                </div>
                ...
                <div className="service-hero_heading max-w-4xl mx-auto text-center z-10 px-4">
                  ...
                  <p className="text-white text-base sm:text-lg md:text-xl lg:text-2xl mt-3 md:mt-4 opacity-90 animate-fadeInUp leading-relaxed" style={{ animationDelay: '0.2s' }}>
                    Report suspected non-compliance in public procurement and asset disposal
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="introduction_component">
                  <div className="introduction_header text-center mb-10 md:mb-12">
                    ...
                    <div className="heading-animate">
                      <h2 className="heading-style-h2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-purple leading-tight">
                        Promoting Accountability Through Investigations
                      </h2>
                    </div>
                  </div>
                  ...
                  <div>
                    <p className="text-base md:text-lg leading-relaxed text-gray-700">
                      PPRA receives, assesses and acts on complaints concerning public procurement and asset disposal proceedings that are not subject to administrative review. The service promotes accountability, protects public resources and supports compliance with the <strong>Public Procurement and Asset Disposal Act, 2015</strong> and the Regulations.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* WHO MAY LODGE A COMPLAINT */}
        <section className="section-complainants relative bg-gray-50">
          <div className="line-wrapper is-invert absolute inset-0 pointer-events-none flex">
            <div className="vertical-line w-1/5 border-r border-gray-200"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            <div className="vertical-line w-1/5 border-none"></div>
          ...
          <div className="z-index-1 relative">
            <div className="padding-global padding-section-large px-4 md:px-6 lg:px-12 py-12 md:py-20">
              <div className="container-large max-w-7xl mx-auto">
                <div className="complainants_component">
                  <div className="complainants_header text-center mb-10 md:mb-14">
                    <div className="pill-wrapper flex justify-center mb-4">
                      <div className="pill is-black inline-block bg-primary-purple text-white text-sm px-4 py-1.5">WHO CAN COMPLAIN</div>
                    </div>
                    <div className="heading-animate">
                      <h2 className="heading-style-h2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-purple leading-tight">
                        Who May Lodge a Complaint?
                  ...
                  <div className="max-w-4xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                      {complainants.map((item, index) => (
                        <div key={index} className="bg-white p-4 md:p-5 border border-gray-200 hover:border-primary-purple/30 hover:shadow-md transition-all duration-300 flex items-start gap-3">
                    ...
                    <div className="mt-6 p-4 md:p-5 bg-primary-purple/5 border-l-4 border-primary-purple">
                      <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                        <FontAwesomeIcon icon={faUserSecret} className="text-primary-purple mr-2" />
                        <strong>Note:</strong> Complaints may be submitted anonymously through the PPRA Complaints Management System.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {/* REPORTABLE MATTERS */}
        <section className="section-matters relative bg-white">
          <div className="line-wrapper is-invert absolute inset-0 pointer-events-none flex">
            <div className="vertical-line w-1/5 border-r border-gray-200"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            <div className="vertical-line w-1/5 border-none"></div>
          ...
          <div className="z-index-1 relative">
            <div className="padding-global padding-section-large px-4 md:px-6 lg:px-12 py-12 md:py-20">
              <div className="container-large max-w-4xl mx-auto">
                <div className="matters_component">
                  <div className="matters_header text-center mb-10 md:mb-14">
                    <div className="pill-wrapper flex justify-center mb-4">
                      <div className="pill is-black inline-block bg-primary-purple text-white text-sm px-4 py-1.5">REPORTABLE MATTERS</div>
                    </div>
                    <div className="heading-animate">
                      <h2 className="heading-style-h2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-purple leading-tight">
                  ...
                  <div className="space-y-3 md:space-y-4">
                    {reportableMatters.map((item, index) => (
                      <div key={index} className="flex items-start gap-3 p-3 md:p-4 bg-gray-50 hover:bg-primary-purple/5 transition-colors duration-300">
                        <div className="w-6 h-6 bg-primary-green/10 rounded-full flex items-center justify-center shrink-0 mt-0.5">
        ...
        {/* WHAT COMPLAINT SHOULD CONTAIN */}
        <section className="section-contents relative bg-gray-50">
          <div className="line-wrapper is-invert absolute inset-0 pointer-events-none flex">
            <div className="vertical-line w-1/5 border-r border-gray-200"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            <div className="vertical-line w-1/5 border-none"></div>
          ...
          <div className="z-index-1 relative">
            <div className="padding-global padding-section-large px-4 md:px-6 lg:px-12 py-12 md:py-20">
              <div className="container-large max-w-4xl mx-auto">
                <div className="contents_component">
                  <div className="contents_header text-center mb-10 md:mb-14">
                    <div className="pill-wrapper flex justify-center mb-4">
                      <div className="pill is-black inline-block bg-primary-purple text-white text-sm px-4 py-1.5">COMPLAINT REQUIREMENTS</div>
                    </div>
                    <div className="heading-animate">
                      <h2 className="heading-style-h2 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary-purple leading-tight">
                    ...
                    <p className="text-gray-600 text-base md:text-lg mt-4 max-w-3xl mx-auto leading-relaxed">
                      To support timely assessment, provide the following information
                    </p>
                  </div>

                  <div className="space-y-3 md:space-y-4">
                    {complaintContents.map((item, index) => (
        ...
        {/* HOW PPRA HANDLES COMPLAINTS */}
        <section className="section-handling relative bg-white">
          <div className="line-wrapper is-invert absolute inset-0 pointer-events-none flex">
            <div className="vertical-line w-1/5 border-r border-gray-200"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            <div className="vertical-line w-1/5 border-none"></div>
          ...
          <div className="z-index-1 relative">
            <div className="padding-global padding-section-large px-4 md:px-6 lg:px-12 py-12 md:py-20">
              <div className="container-large max-w-4xl mx-auto">
                <div className="handling_component">
                  <div className="handling_header text-center mb-10 md:mb-14">
                    <div className="pill-wrapper flex justify-center mb-4">
                  ...
                  <div className="mt-8 p-4 md:p-6 bg-primary-purple/5 border-l-4 border-primary-purple">
                    <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                      <strong>Note:</strong> Investigations may involve examination of procurement records, contracts, accounts, correspondence and other relevant evidence. Matters involving possible criminal, corruption, professional or disciplinary offences may be referred to the appropriate authority.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {/* IMPORTANT NOTE */}
        <section className="section-important relative bg-gray-50">
          <div className="line-wrapper is-invert absolute inset-0 pointer-events-none flex">
            <div className="vertical-line w-1/5 border-r border-gray-200"></div>
            <div className="vertical-line w-1/5 border-none"></div>
            <div className="vertical-line w-1/5 border-none"></div>
          ...
          <div className="z-index-1 relative">
            <div className="padding-global padding-section-large px-4 md:px-6 lg:px-12 py-12 md:py-20">
              <div className="container-large max-w-4xl mx-auto">
                <div className="important_component">
                  <div className="important_header text-center mb-8 md:mb-10">
                    <div className="pill-wrapper flex justify-center mb-4">
                      <div className="pill is-black inline-block bg-primary-red text-white text-sm px-4 py-1.5">IMPORTANT</div>
                    </div>
                  </div>

                  <div className="bg-red-50 border-l-4 border-primary-red p-6 md:p-8">
                    <div className="flex items-start gap-4">
                      <div className="w-10 h-10 bg-primary-red/10 rounded-full flex items-center justify-center shrink-0">
                        <FontAwesomeIcon icon={faExclamationTriangle} className="text-primary-red text-lg" />
                      </div>
                      <div>
                        <h3 className="text-lg md:text-xl font-bold text-primary-red mb-2">Complaint vs Administrative Review</h3>
                        <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                          A complaint to PPRA is not a substitute for administrative review before the Public Procurement Administrative Review Board. If you are a candidate or tenderer seeking to challenge a procurement or asset disposal decision that has caused, or may cause, loss or damage, you may need to file a Request for Review within the statutory <strong>14-day period</strong>. Do not assume that submitting a complaint to PPRA will suspend the procurement proceedings or extend the administrative-review deadline.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 p-4 md:p-6 bg-primary-purple/5 border-l-4 border-primary-purple">
                    <h4 className="text-base md:text-lg font-bold text-primary-purple mb-2">
                      <FontAwesomeIcon icon={faShieldAlt} className="mr-2" />
                      Confidentiality
                    </h4>
                    <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                      PPRA handles complaints, personal information and investigation records in accordance with applicable confidentiality, access-to-information and data-protection requirements.
                    </p>
                  </div>
                </div>
              </div>
...
export default ComplaintsAndInvestigations;